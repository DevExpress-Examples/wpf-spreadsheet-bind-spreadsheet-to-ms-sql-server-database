...
Partial Public Class NWindDataSet
    ...
    Partial Public Class SuppliersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddSuppliersRow(ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal Address As String, ByVal City As String, ByVal Country As String, ByVal Phone As String, ByVal Fax As String) As SuppliersRow
    ...
    Partial Public Class SuppliersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Suppliers] WHERE (([SupplierID] = @Original_SupplierID) AND (["& _ 
                ...
                "ntry)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phon"& _ 
                "e)) AND ((@IsNull_Fax = 1 AND [Fax] IS NULL) OR ([Fax] = @Original_Fax)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Suppliers] ([CompanyName], [ContactName], [ContactTitle], [Add"& _ 
                "ress], [City], [Country], [Phone], [Fax]) VALUES (@CompanyName, @ContactName, @C"& _ 
                "ontactTitle, @Address, @City, @Country, @Phone, @Fax);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT SupplierID, Compa"& _ 
                "nyName, ContactName, ContactTitle, Address, City, Country, Phone, Fax FROM Suppl"& _ 
                "iers WHERE (SupplierID = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Suppliers] SET [CompanyName] = @CompanyName, [ContactName] = @Conta"& _ 
                "ctName, [ContactTitle] = @ContactTitle, [Address] = @Address, [City] = @City, [C"& _ 
                "ountry] = @Country, [Phone] = @Phone, [Fax] = @Fax WHERE (([SupplierID] = @Origi"& _ 
                ...
                " AND ((@IsNull_ContactTitle = 1 AND [ContactTitle] IS NULL) OR ([ContactTitle] ="& _ 
                " @Original_ContactTitle)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR (["& _ 
                "Address] = @Original_Address)) AND ((@IsNull_City = 1 AND [City] IS NULL) OR ([C"& _ 
                "ity] = @Original_City)) AND ((@IsNull_Country = 1 AND [Country] IS NULL) OR ([Co"& _ 
                "untry] = @Original_Country)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([P"& _ 
                "hone] = @Original_Phone)) AND ((@IsNull_Fax = 1 AND [Fax] IS NULL) OR ([Fax] = @"& _ 
                "Original_Fax)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT SupplierID, CompanyName, ContactName, ContactTitle, Add"& _ 
                "ress, City, Country, Phone, Fax FROM Suppliers WHERE (SupplierID = @SupplierID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT SupplierID, CompanyName, ContactName, ContactTitle, Address, City, Country"& _ 
        ...
        Public Overloads Overridable Function Insert(ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal Address As String, ByVal City As String, ByVal Country As String, ByVal Phone As String, ByVal Fax As String) As Integer
        ...
        Public Overloads Overridable Function Update( _
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(24).Value = CType(SupplierID,Integer)
