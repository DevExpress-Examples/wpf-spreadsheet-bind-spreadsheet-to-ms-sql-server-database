    ...
    Partial Public Class NWindDataSet
        ...
        Partial Public Class SuppliersDataTable
            ...
            Public Function AddSuppliersRow(ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal Address As String, ByVal City As String, ByVal Country As String, ByVal Phone As String, ByVal Fax As String) As SuppliersRow
                ...
                Dim columnValuesArray() As Object = { Nothing, CompanyName, ContactName, ContactTitle, Address, City, Country, Phone, Fax}
...
Namespace WpfSpreadsheet_BindToDataSource.NWindDataSetTableAdapters
    ...
    Partial Public Class SuppliersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Suppliers] ([CompanyName], [ContactName], [ContactTitle], [Address], [City], [Country], [Phone], [Fax]) VALUES (@CompanyName, @ContactName, @ContactTitle, @Address, @City, @Country, @Phone, @Fax);" & ControlChars.CrLf & _
...
"SELECT SupplierID, CompanyName, ContactName, ContactTitle, Address, City, Country, Phone, Fax FROM Suppliers WHERE (SupplierID = @SupplierID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT SupplierID, CompanyName, ContactName, ContactTitle, Address, City, Country" & ", Phone, Fax FROM dbo.Suppliers"
        ...
        Public Overridable Function Delete(ByVal Original_SupplierID As Integer, ByVal Original_CompanyName As String, ByVal Original_ContactName As String, ByVal Original_ContactTitle As String, ByVal Original_Address As String, ByVal Original_City As String, ByVal Original_Country As String, ByVal Original_Phone As String, ByVal Original_Fax As String) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(11).Value = (CStr(Original_Country))
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(13).Value = (CStr(Original_Phone))
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(15).Value = (CStr(Original_Fax))
            End If
        ...
        Public Overridable Function Insert(ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal Address As String, ByVal City As String, ByVal Country As String, ByVal Phone As String, ByVal Fax As String) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(6).Value = (CStr(Phone))
            End If
            If (Fax Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(7).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(7).Value = (CStr(Fax))
            End If
        ...
        Public Overridable Function Update(ByVal CompanyName As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal Address As String, ByVal City As String, ByVal Country As String, ByVal Phone As String, ByVal Fax As String, ByVal Original_SupplierID As Integer, ByVal Original_CompanyName As String, ByVal Original_ContactName As String, ByVal Original_ContactTitle As String, ByVal Original_Address As String, ByVal Original_City As String, ByVal Original_Country As String, ByVal Original_Phone As String, ByVal Original_Fax As String, ByVal SupplierID As Integer) As Integer
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(6).Value = (CStr(Phone))
            End If
            If (Fax Is Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(7).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(7).Value = (CStr(Fax))
            End If
            Me.Adapter.UpdateCommand.Parameters(8).Value = (CInt(Original_SupplierID))
            If (Original_CompanyName Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_CompanyName")
            Else
                Me.Adapter.UpdateCommand.Parameters(9).Value = (CStr(Original_CompanyName))
            End If
            If (Original_ContactName Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(11).Value = (CStr(Original_ContactName))
            End If
            If (Original_ContactTitle Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(13).Value = (CStr(Original_ContactTitle))
            End If
            If (Original_Address Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(15).Value = (CStr(Original_Address))
            End If
            If (Original_City Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(17).Value = (CStr(Original_City))
            End If
            If (Original_Country Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(19).Value = (CStr(Original_Country))
            End If
            If (Original_Phone Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(21).Value = (CStr(Original_Phone))
            End If
            If (Original_Fax Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(23).Value = (CStr(Original_Fax))
            End If
            Me.Adapter.UpdateCommand.Parameters(24).Value = (CInt(SupplierID))
        ...
        Public Overridable Function UpdateAll(ByVal dataSet As NWindDataSet) As Integer
            ...
            Try
                ...
                If (Me._suppliersTableAdapter IsNot Nothing) Then
                    ...
                    Me._suppliersTableAdapter.Connection = (DirectCast(workConnection, Global.System.Data.SqlClient.SqlConnection))
                    Me._suppliersTableAdapter.Transaction = (DirectCast(workTransaction, Global.System.Data.SqlClient.SqlTransaction))
            ...
            Finally
                ...
                End If
                If (Me._suppliersTableAdapter IsNot Nothing) Then
                    Me._suppliersTableAdapter.Connection = (DirectCast(revertConnections(Me._suppliersTableAdapter), Global.System.Data.SqlClient.SqlConnection))
